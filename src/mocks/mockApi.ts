...
const matchingHistory: GetInstructorMatchingHistoryResponse['data'] = [
	{
		...
		lessonPostStatus: 'OPEN',
		matchingStatus: 'MATCHING_WAIT',
		subject: '스키',
		headcount: 2,
		applicantCount: 2,
	},
	...
	},
	{
		...
		lessonPostStatus: 'WAIT_PAYMENT',
		matchingStatus: 'PAYMENT_WAIT',
		subject: '스키',
		headcount: 3,
		applicantCount: 1,
	},
